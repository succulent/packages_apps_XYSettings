...
public class PropModder extends SettingsPreferenceFragment implements
    ...
    private static final String TAG = "XYE :PropModder";
    ...
    public void onPause() {
        super.onPause();
        Log.d(TAG, "com.xylon.settings.fragments.PropModder has been paused");
    }

    @Override
    public void onResume() {
        super.onResume();
        Log.d(TAG, "com.xylon.settings.fragments.PropModder is being resumed");
    }
